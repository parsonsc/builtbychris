...
<html>
    <head>
        ...
        <meta name="keywords" content="HTML, CSS, Jquery, JavaScript, Chris, Chris Parsons, Web Developer, Front end developer, Front end, portfolio, contact, wordpress, typo3,">
                            ...
                            <a href="french-connection.html" data-anim="la-anim-1">
                                <figure class="hover_effect fcuk">
                                    ...
                                    <figcaption>
                                        ...
                                        <!-- <p>Lorem sits in the corner the whole day. She's into crochet.</p> -->
                ...
                <div class="inner_content">
                    ...
                    <?php if(!empty($emailSent)): ?>
                        <div class="col-md-6 col-md-offset-3">
                            <div class="alert alert-success text-center">Thanks for the messge</div>
                        </div>
                    <?php else: ?>
